...
export {delSomeArrayItem} from './array/delSomeArrayItem';
export {different} from './array/different';
export {dropLeftItem} from './array/dropLeftItem';
export {dropRightItem} from './array/dropRightItem';
